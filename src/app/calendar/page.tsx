...
export default function Page() {
  ...
  return (
    ...
    <div className="relative min-h-screen bg-calendar-bg bg-cover bg-center flex justify-center items-center">
      ...
      {/* frosted glass */}
      <div className="w-full md:w-4/5 min-h-screen md:min-h-4 bg-lightPurple bg-opacity-10 backdrop-filter backdrop-blur brightness-125 rounded-lg p-2 md:p-10">
        {/* HEADLINE ROW */}
