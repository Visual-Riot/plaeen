    ...
    <div className="bg-[#6606E3]/5 w-full h-[100vh] flex flex-col items-center">
      ...
      {/* Log in / Sign in Card */}
        ...
        <div>
          ...
          <button onClick={()=> console.log('clicked')}className="text-lightGrey text-lg mt-8 border-4 border-green rounded-[10px] w-full p-5 border-opacity-50 flex items-center justify-center gap-7">
            <FcGoogle size={24} />
