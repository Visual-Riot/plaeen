...
const LandingPage = () => {
  return (
    <div className="min-h-[80vh] md:min-h-[90vh] w-full bg-[url('/img/hero-bg-noshadow.webp')] bg-cover bg-bottom pb-8 md:pb-20 mb-[14rem] flex flex-col">
      <HomeNavbar />
      <div className="flex-grow flex items-center">
        <div className="relative space-y-4 md:space-y-6 lg:space-y-8 px-6 md:px-16 ">
          <h1 className="text-neonGreen font-semibold font-sofia text-center sm:text-left landing-heading w-full  sm:w-[80%] lg:w-[65%] xl:w-[55%] text-4xl md:text-5xl lg:text-6xl">
