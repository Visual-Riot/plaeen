  ...
  return (
    <div className="h-[85vh] w-screen bg-[url('/img/hero-bg-noshadow.webp')] bg-cover bg-bottom mb-[16rem]">
      ...
      <div className="relative top-[0%] 2xl:top-[10%] space-y-5 px-6 sm:px-12 md:px-20 lg:px-32">
        ...
        <p className="landing-paragraph text-lightGrey font-sofia font-extralight py-3 w-full md:w-[80%] xl:w-[50%] text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl leading-[1.6]">
