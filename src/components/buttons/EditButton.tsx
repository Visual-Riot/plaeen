    ...
    >
      ...
      >
        <path
          ...
          d="M15.232 5.232l3.536 3.536-3.75 3.75H11.5V8.982l3.732-3.75zm1.768-.768a2 2 0 112.828 2.828L18.06 9.768l-3.536-3.536 2.476-2.468zM12 12.25v3.25h3.25L19.5 12M5.5 20.5h13"
        />
      </svg>
      {children}
    </button>
